    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-8 md:px-16 py-16">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-3xl mb-4">Welcome to The ALANA Project</h2>
          ...
          <div>
            <h3 className="text-2xl mb-4">1. Acceptance of Terms</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">2. Changes to Terms</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">3. Privacy</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">4. Your Accounts and Wallets</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">5. Content and Conduct</h3>
            <p className="leading-relaxed mb-4">
              <strong>a.</strong> Content posted on The ALANA Project's Services is the sole responsibility of the person who originated such content. The views and opinions expressed on The ALANA Project's Services are those of the person who expressed it, and do not necessarily reflect the views or positions of The ALANA Project as a whole. You certify that you own all intellectual property rights in your content or have the right to use and allow the use of this content on the Services.
            </p>
            <p className="leading-relaxed mb-4">
              <strong>b.</strong> You agree not to display, upload, post, transmit, or share content that is illegal, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, or otherwise objectionable.
            </p>
            <p className="leading-relaxed">
              <strong>c.</strong> The ALANA Project reserves the right to remove any content or suspend users found to be in violation of these Terms.
            </p>
          </div>

          <div>
            <h3 className="text-2xl mb-4">6. Intellectual Property</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">7. Third-Party Links and Content</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">8. Termination</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">9. Disclaimer and Limitation of Liability</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">10. Governing Law</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">11. Changes to Services</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">12. Taxation</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">13. Labor regulation</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl mb-4">14. Contact Information</h3>
            <p className="leading-relaxed">
      ...
      <footer className="border-t border-border px-8 md:px-16 py-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex gap-6">
            <button 
              className="text-[16px] pb-2 text-accent transition-colors cursor-default"
            >
              Terms of Service
            </button>
