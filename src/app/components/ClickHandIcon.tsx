interface ClickHandIconProps {
  className?: string;
}

export function ClickHandIcon({ className = "" }: ClickHandIconProps) {
  return (
    <svg
      viewBox="0 0 36 36"
      fill="currentColor"
      ...
      className={className}
    >
      <path d="M30.4,17.6c-1.8-1.9-4.2-3.2-6.7-3.7c-1.1-0.3-2.2-0.5-3.3-0.6c2.8-3.3,2.3-8.3-1-11.1s-8.3-2.3-11.1,1s-2.3,8.3,1,11.1
